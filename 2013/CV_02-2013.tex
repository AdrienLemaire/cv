...
\ecvEPR{Addresse}{1-32-32 Maison Nagome 302\ecvNewLine
                  904-2172 Awase, Japan}
...
\ecvENR{Main responsibilities}
        {System Administration (AWS management, monitoring and profiling).
         Django \& OpenERP Projects management.
         CI \& QA expert.
         Suport, Documentation.
         Relation Developers, Sales and Customers.
...
\ecvEFR{Other}{\ecvBold{Certifications}}
\ecvENR{}
...
\ecvBEBSub{Hobbies}
                {
                 Marathon, Karate, Music (piano), Go game, DIY anything
                }
