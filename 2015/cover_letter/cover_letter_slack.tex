...
\includegraphics[width=1.2\linewidth]{slack-logo.png}}} % Company/institution logo at the top left of the page
...
% Hootan Altafi -> Talent Acquisition & Operations
% Brianna Headsten -> Recruiting Coordination
% Mabel So -> Recruiting Coordinator
% Lucas Coffee -> Recruiter
% Lauren (Williams Hoe) -> Recruiter
% Cal Henderson -> CTO


\greetto{Dear Mr Henderson,} % Greeting text
\closeline{Sincerely yours,} % Closing text

\nameto{Mr. Cal Henderson} % Addressee of the letter above the to address
