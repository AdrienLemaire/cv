...
\includegraphics[width=1.2\linewidth]{sharewis-logo.jpeg}}} % Company/institution logo at the top left of the page
...
\greetto{Dear Mr Tsujikawa,} % Greeting text
\closeline{Sincerely yours,} % Closing text

\nameto{Mr. Tomoki Tsujikawa} % Addressee of the letter above the to address

\addrto{
ShareWis Inc\\
Shimanouchi, 1 Chome−17−12\\
Osaka-shi, Chuo-ku,\\
542-0082 Osaka-fu
}
