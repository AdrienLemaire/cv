...
\includegraphics[width=1.2\linewidth]{memrise-logo.png}}} % Company/institution logo at the top left of the page
...
\greetto{Dear Mr Zohar,} % Greeting text
\closeline{Sincerely yours,} % Closing text

\nameto{Mr. Daniel Zohar} % Addressee of the letter above the to address
