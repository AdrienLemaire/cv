...
\includegraphics[width=1.2\linewidth]{trello-logo.png}}} % Company/institution logo at the top left of the page
...
\greetto{Dear Mr Clark,} % Greeting text
\closeline{Sincerely yours,} % Closing text

\nameto{Mr. Barry Clark} % Addressee of the letter above the to address
