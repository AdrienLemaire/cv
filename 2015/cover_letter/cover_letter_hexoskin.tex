...
\includegraphics[width=1.2\linewidth]{hexoskin.png}}} % Company/institution logo at the top left of the page
...
\greetto{Dear Mr. Fournier,} % Greeting text
\closeline{Sincerely yours,} % Closing text

\nameto{Mr. Pierre-Alexandre Fournier} % Addressee of the letter above the to address

\addrto{
Carre Technologies Inc.\\
5800 St-Denis, suite 402A\\
Montreal, Quebec\\
CANADA\\
H2S 3L5
}
